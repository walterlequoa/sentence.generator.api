...
namespace sentence.generator.api.Controllers
{
    ...
    public class UsersController : BaseApiController
    {
        ...
        {
            if (refreshTokenRequest == null || string.IsNullOrEmpty(refreshTokenRequest.RefreshToken) || string.IsNullOrEmpty(refreshTokenRequest.UserId))
            {
                return BadRequest(new TokenResponse
                {
        ...
        [HttpPost]
        [Route("signup")]
        public async Task<IActionResult> Signup(UserDetails signupRequest)
        {
